/* Moment 3.1 DT207G VT24, Åsa Lindskog, sali1502@student.miun.se */

"use strict";

let url = "http://127.0.0.1:3000/workexperiences";
    ...
    if (document.getElementById("updateWorkForm")) {
        ...
        window.onload = async function () {
            ...
            if (id) {
                ...
                document.getElementById("companyname").value = dataset.companyname;
...
async function createWork(companyname, jobtitle, location, startdate, enddate, description) {
...
async function updateWork(id, companyname, jobtitle, location, startdate, enddate, description) {
